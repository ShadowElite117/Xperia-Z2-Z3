...
#include "include/sdioh.h"	/* Standard SDIO Host Controller Specification */
#include "include/bcmsdbus.h"	/* bcmsdh to/from specific controller APIs */
#include "include/sdiovar.h"	/* ioctl/iovars */
...
#endif
#include "include/bcmsdh_sdmmc.h"
